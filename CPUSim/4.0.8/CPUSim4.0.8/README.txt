...
1.  Download the CPUSim4.0.8.zip file onto your hard disk.

2.  Unzip the CPUSim4.0.8.zip file. The unzipping process
will create a folder called "CPUSim4.0.8" containing 4
documents, a folder "cpusim", and a folder "SampleAssignments".
...
MacOS X users will find Java comes installed with the OS, but
...
32  On a Linux or Macintosh computer or for those who prefer to use the command line,
    (a) open a command or terminal window and navigate to
        the "CPUSim4.0.8" folder.
